...
class gi4e_eye(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        LorR = self.label[idx][0].split('_')[0]
        img_id = '_'.join(self.label[idx][0].split('_')[1:])
        ...
        plt.scatter(eye_pts_copy[:, 0], eye_pts_copy[:, 1], s=5, marker='.', c='r')
        ...
        return img, heatmaps, eye_pts, pupil_dist, Width, Height, LorR, img_id
...
if __name__ == '__main__':
    ...
    dataTrain = gi4e_eye(data_path=r'D:\gi4e_database\blend', json_path=r'D:\gi4e_database\blend_eye_pt.json',sigma=2,img_size=64,heatmap_size=64)
    
    img, heatmaps, eye_pts, pupil_dist, Width, Height, LorR, img_id = dataTrain[100]
    print(LorR)
    print(img_id)
