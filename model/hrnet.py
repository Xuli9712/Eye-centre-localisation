...
model_urls = {
    'hrnet_w18_small': 'https://download.openmmlab.com/pretrain/third_party/hrnetv2_w18_small-ea053f73.pth',
    'hrnet_w18': 'https://download.openmmlab.com/pretrain/third_party/hrnetv2_w18-d218c3b5.pth',
    'hrnet_w32': 'https://download.openmmlab.com/pretrain/third_party/hrnetv2_w32-1b3f928a.pth',
    'hrnet_w40': 'https://download.openmmlab.com/pretrain/third_party/hrnetv2_w40-8ab84412.pth',
}
...
# 修改输出为(Batch_size, 6, 64, 64)
class HighResolutionNetModified(nn.Module):
    def __init__(self, pretrained=False, **kwargs):
        super(HighResolutionNetModified, self).__init__()
        ...
        **kwargs
        ...
        self.additional_head = nn.Sequential(
            nn.Conv2d(270, 270, 1, bias=False),
            nn.BatchNorm2d(270),
            nn.ReLU(inplace=True),
            nn.Conv2d(270, 3, 1, bias=False),
        )
    def forward(self, x):
        x = self.hrnet(x)
...
def hrnet18_modified(pretrained=False, **kwargs):
    model = HighResolutionNetModified(pretrained=False, **kwargs)
    return model
